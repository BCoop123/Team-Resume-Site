...
$resumes = [
	[
		...
		[
			...
			[
			'Skill_2_Name' => "HTML/CSS/JavaScript",
			'Skill_2_Progress' => "98",
			],
			[
			'Skill_3_Name' => "Oracle SQL",
			'Skill_3_Progress' => "89",
			],
		],
		'OtherSkills' =>
		...
		[
			[
			'Award_1_Name' => "Governors Scholar",
			'Award_1_Descr' => "Scholarship awarded to distinguished students in the state of Kentucky.",
			],
			[
			'Award_2_Name' => "Congressional Award",
			'Award_2_Descr' => "Award given to volunteers in Kentucky with over 300 clocked hours.",
			],
		],
		'Languages' =>
		[
